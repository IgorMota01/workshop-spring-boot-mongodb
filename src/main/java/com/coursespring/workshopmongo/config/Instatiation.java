...
import com.coursespring.workshopmongo.dto.AuthorDTO;
import com.coursespring.workshopmongo.dto.CommentDTO;
...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("17/12/2022"), "Partiu viagem !",  "Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("05/12/2022"), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
